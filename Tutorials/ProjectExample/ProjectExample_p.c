...
#pragma code_seg(".orpc")
static const FormatInfoRef IMyObject_Ndr64ProcTable[] =
    {
...
static const MIDL_SYNTAX_INFO IMyObject_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    ...
    0,
    0 ,
    (unsigned short *) &IMyObject_Ndr64ProcTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IMyObject_ProxyInfo =
    ...
    2,
    (MIDL_SYNTAX_INFO*)IMyObject_SyntaxInfo
...
static const MIDL_SERVER_INFO IMyObject_ServerInfo = 
    ...
    0,
    ProjectExample__MIDL_ProcFormatString.Format,
    (unsigned short *) &IMyObject_FormatStringOffsetTable[-3],
    0,
